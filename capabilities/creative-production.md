...
The CEO has authorized a bounded exception to the Article VI Identity Firewall permitting the Creative Director to access DALL-E, Midjourney, and Stable Diffusion via the CEO's personal accounts ([YOUR_IMAGE_GEN_ACCOUNT]).
...
- Class C (Sensitive) — client deliverables, brand strategy documents, any asset destined for external delivery
