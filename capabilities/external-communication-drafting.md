...
| --- | --- | --- |
| [YOUR_ORG_EMAIL] | Send (to CEO only) | For operational reports and escalations |
...
All CEO-bound communications are sent by the President Agent from [YOUR_ORG_EMAIL] to [YOUR_PERSONAL_EMAIL]. The Operations Director does not deliver reports to the CEO; report delivery is the President Agent's direct responsibility and authority.
