...
[YOUR_MAL] Maximum Acceptable Loss (equal to monthly cap). Any unexpected charge outside the pre-approved vendor list is a High incident regardless of amount.
