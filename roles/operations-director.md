...
| Sandbox inbox folder | Designated filesystem folder on the sandbox host | CEO drops file; Operations Director picks up and processes |
| Email | From [YOUR_PERSONAL_EMAIL] to [YOUR_ORG_EMAIL] | Operations Director monitors and processes |
...
- Provider: [YOUR_VIRTUAL_CARD_PROVIDER] virtual card (to be provisioned)
- Pre-approved vendors: Anthropic API, GitHub, Google Workspace
- Other vendors: require CEO approval before spending
- Per-transaction limit: [YOUR_TX_LIMIT]/transaction
- Monthly cap: [YOUR_MONTHLY_CAP]/month
- Maximum acceptable loss: [YOUR_MAL] Maximum Acceptable Loss
